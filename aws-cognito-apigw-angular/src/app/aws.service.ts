...
export class AwsService {
 ...
 /************ RESOURCE IDENTIFIERS *************/
  ...
  googleId:string = '699136709706-0banke28fu67r1q1ggjpvolfa9ujkctu.apps.googleusercontent.com';
  poolData = {
        UserPoolId : 'us-east-1_X9tASjFFY', //CognitoUserPool
        ClientId : '71i15b61ia93atcdupbb4jaggs', //CognitoUserPoolClient
        Paranoia : 7
    };
  identityPool:string = 'us-east-1:083e41ce-d157-4be9-826a-3c653cc79c06'; //CognitoIdentityPool
  apiURL:string = 'https://djep7lj9s1.execute-api.us-east-1.amazonaws.com/demo';  //ApiUrl
